...
internal sealed class InterfaceBridge
{
    ...
    public Translation Module { get; }

    private readonly ILogger<InterfaceBridge> _logger;

    public InterfaceBridge(string dllPath, string sharpPath, Version version, Translation module, ISharedSystem sharedSystem)
    {
        SharpPath = sharpPath;
        DllPath = dllPath;
        ...
        FileVersion = FileVersionInfo.GetVersionInfo(Path.Combine(dllPath, "Translation.dll"));
